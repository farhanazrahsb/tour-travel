    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Input Wisata</div>
        <div class="card-body">
          <div class="table-responsive">
          <form method="post" enctype="multipart/form-data">
          <label>Tanggal</label>
          <input type="text" name="tanggal" class="form-control" placeholder="Tanggal" value="<?php date_default_timezone_set("Asia/Jakarta");echo date("l, d-m-Y / H:i");?>" readonly>
          <br>
          <label>ID Wisata</label>
          <input type="text" name="id_wisata" class="form-control" placeholder="ID Wisata">
          <br>
          <label>Nama</label>
          ...
          <select name="durasi" class="form-control">
            <option selected="selected">-- Pilih Durasi --</option>
          ...
          <br>
          <label>Rincian</label>
          <textarea name="rinci"></textarea>
          <br>
          <label>Keterangan</label>
          <textarea name="keterangan"></textarea>
          <br>
          <label>Kegiatan</label>
          <textarea name="kegiatan"></textarea>
          <br>
          <label>Gambar</label>
          ...
          $query = mysql_query("INSERT INTO wisata (id_wisata,nama,lokasi,harga,durasi,rinci,deskripsi,keterangan,kegiatan,tanggal,gambar) VALUES ('$_POST[id_wisata]', '$_POST[nama]', '$_POST[lokasi]', '$_POST[harga]', '$_POST[durasi]', '$_POST[rinci]', '$_POST[deskripsi]', '$_POST[keterangan]', '$_POST[kegiatan]', '$_POST[tanggal]', '$nama')");

          if ($query){
          echo "<script>alert('Berhasil Menginput')</script>";
          echo "<meta http-equiv='refresh' content='1 url=inputwisata.php'>";
          }else{
