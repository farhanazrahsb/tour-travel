    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Input Kendaraan</div>
        <div class="card-body">
          ...
          <br>
          <label>Harga</label>
          <input type="text" name="harga_kend" class="form-control" placeholder="Harga">
          <br>
          <label>Gambar</label>
          ...
          $query = mysql_query("INSERT INTO kendaraan (id_kendaraan,nama_kendaraan,tipe_kendaraan,kapasitas,harga_kend,gambar) VALUES ('$_POST[id_kendaraan]', '$_POST[nama_kendaraan]', '$_POST[tipe_kendaraan]', '$_POST[kapasitas]', '$_POST[harga_kend]', '$nama')");

          if ($query){
          echo "<script>alert('Berhasil Menginput')</script>";
          echo "<meta http-equiv='refresh' content='1 url=inputkendaraan.php'>";
          }else{
