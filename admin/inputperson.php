    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Input Person</div>
        <div class="card-body">
          ...
          <br>
          <label>Harga</label>
          <input type="text" name="harga_per" class="form-control" placeholder="Harga">
          <br>
          ...
          $query = mysql_query("INSERT INTO extra_person (id_anggota,jumlah,harga_per) VALUES ('$_POST[id_anggota]', '$_POST[jumlah]', '$_POST[harga_per]')");

          if ($query){
          echo "<script>alert('Berhasil Menginput')</script>";
          echo "<meta http-equiv='refresh' content='1 url=inputperson.php'>";
          }else{
