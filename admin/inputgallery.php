    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Input Gallery</div>
        <div class="card-body">
          <div class="table-responsive">
          <form method="post" enctype="multipart/form-data">
          <label>ID Gambar</label>
          <input type="text" name="id_gambar" class="form-control" placeholder="ID Gambar">
          <br>
          <label>Keterangan</label>
          <input type="text" name="ket_gambar" class="form-control" placeholder="Keterangan">
          <br>
          <label>Gambar</label>
          ...
          $query = mysql_query("INSERT INTO gallery (id_gambar,ket_gambar,gambar) VALUES ('$_POST[id_gambar]', '$_POST[ket_gambar]', '$nama')");
