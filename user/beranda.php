			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="myNavbar" style="color: white;">
				  <ul class="nav navbar-nav">
				    ...
				    <li class="dropdown">
				      <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white;"> <i class="fa fa-wrench" aria-hidden="true"></i> Setting</a>
				...
				<div class="top-nav">
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav">
									<li><a class="active list-border scroll" href="beranda.php">Home</a></li>
			...
			<div class="container">
				...
				<div class="wthree-news-grids">
					<div class="col-md-6 agile-news-right-info">
						<div class="col-sm-4">
							<img src="../admin/gambar/<?php echo $var['gambar'];?>" height="520" width="170">
						</div>
						<div class="col-sm-8 agile-news-img-info">
							...
							<p><h6><i class="fa fa-price" aria-hidden="true"></i> Rp <?php echo $var ['harga']; ?>,-00 / 2 Person</h6></p>
							<a href="viewdetail.php?&id_wisata=<?php echo $var['id_wisata']; ?>"><button class="btn btn-info">Pesan</button></a><h1 style="font-size: 12px; color: blue;">*/ Pemesanan untuk penambahan anggota dan kendaraan</h1>
							<a href="viewdetail2.php?&id_wisata=<?php echo $var['id_wisata']; ?>"><button class="btn btn-success">Pesan</button></a><h1 style="font-size: 12px; color: green;">*/ Pemesanan hanya untuk 2 orang dan tanpa menggunakan jasa transportasi tour & travels</h1>
						</div>
