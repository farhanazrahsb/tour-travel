			...
			<div class="container">
				...
				<div class="agile-contact-grids">
					...
					<?php
			          ...
			          $query = mysql_query("INSERT INTO pesan2 (status, username, id_wisata, tanggal_pesan, nama_wisata, lokasi, harga_paket, nama_pesan, no_hp, email, seat, date, alamat) VALUES ('$_POST[status]', '$_POST[username]', '$_POST[id_wisata]', '$_POST[tanggal_pesan]', '$_POST[nama_wisata]', '$_POST[lokasi]', '$_POST[harga_paket]', '$_POST[nama_pesan]', '$_POST[no_hp]', '$_POST[email]', '$_POST[seat]', '$_POST[date]', '$_POST[alamat]')");
