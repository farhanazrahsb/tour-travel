...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM pesan2 WHERE no=".$_GET['no'];
...
$total_tf 		= $_POST['total_tf'];
 ...
 $sql_query = "UPDATE pesan2 SET nama_rek='$nama_rek', nama_bank='$nama_bank', no_rek='$no_rek', no_rek_tour='$no_rek_tour', total_tf='$total_tf' WHERE no=".$_GET['no'];
 // sql query for update data into database
